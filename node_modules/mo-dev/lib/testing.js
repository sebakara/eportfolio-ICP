...
function runTests(options, callback) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (settings.verbosity >= 1) {
            console.log(picocolors_1.default.magenta(dfxSources));
        }
        if (settings.verbosity >= 0) {
            console.log(`Running ${paths.length} unit test file${paths.length === 1 ? '' : 's'} ${picocolors_1.default.dim(`(${testFilePattern})`)}\n`);
        }
                ...
                if (settings.verbosity >= 0) {
                    ...
                    if (important) {
                        ...
                        if ((_b = run.stderr) === null || _b === void 0 ? void 0 : _b.trim()) {
                            console.error(picocolors_1.default.red(run.stderr));
                        }
                    }
...
function runTest(test, mode, settings, { mocPath, dfxSources }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (mode === 'interpreter') {
                const interpretResult = yield (0, execa_1.default)(`${(0, shell_escape_1.default)([mocPath, '-r', path])} ${dfxSources}`, { shell: true, cwd: settings.directory, reject: false });
                return {
                    test,
                    mode,
                ...
                try {
                    yield (0, execa_1.default)(`${(0, shell_escape_1.default)([
                        ...
                        wasmPath,
                        path,
                    ])} ${dfxSources}`, { shell: true, cwd: settings.directory });
